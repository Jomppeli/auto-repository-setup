...
**This script uses Githubs API to add folders and files in wanted order and structure to a Github repository in seconds and saves you the manual work of creating folders and files inside each other.**  
